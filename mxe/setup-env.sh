...
make qtbase qtsvg qttools qttranslations boost protobuf sqlite flac ogg vorbis libsndfile dlfcn-win32 opus cc MXE_PLUGIN_DIRS=plugins/examples/qt5-freeze -j4
