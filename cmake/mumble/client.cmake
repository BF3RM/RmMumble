...
if(WIN32)
    ...
    list(REMOVE_ITEM MUMBLE_HEADERS ${CMAKE_SOURCE_DIR}/src/mumble/PulseAudio.h)
    list(REMOVE_ITEM MUMBLE_HEADERS ${CMAKE_SOURCE_DIR}/src/mumble/OSS.h)
else()
...
list(REMOVE_ITEM MUMBLE_HEADERS ${CMAKE_SOURCE_DIR}/src/mumble/ApplicationPaletteTemplate.h)
list(REMOVE_ITEM MUMBLE_HEADERS ${CMAKE_SOURCE_DIR}/src/mumble/BonjourClient.h)
list(REMOVE_ITEM MUMBLE_HEADERS ${CMAKE_SOURCE_DIR}/src/mumble/PAAudio.h)
list(REMOVE_ITEM MUMBLE_HEADERS ${CMAKE_SOURCE_DIR}/src/mumble/TextToSpeech.h)
list(REMOVE_ITEM MUMBLE_HEADERS ${CMAKE_SOURCE_DIR}/src/mumble/JackAudio.h)
list(REMOVE_ITEM MUMBLE_HEADERS ${CMAKE_SOURCE_DIR}/src/mumble/G15LCDEngine_lglcd.h)
list(REMOVE_ITEM MUMBLE_HEADERS ${CMAKE_SOURCE_DIR}/src/mumble/G15LCDEngine_helper.h)
list(REMOVE_ITEM MUMBLE_HEADERS ${CMAKE_SOURCE_DIR}/src/mumble/GlobalShortcut_macx.h)
