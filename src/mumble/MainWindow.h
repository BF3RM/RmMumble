...
public:
    ...
    inline class RMSocket* GetSocket() const
    {
        return RmSocket;
    }
    ...
    void setStatusLeft(std::string message)
    {
        statusLeft.setText(QString::fromStdString(message));
    };
    void setStatusMid(std::string message)
    {
        statusMid.setText(QString::fromStdString(message));
    };
    void setStatusRight(std::string message)
    {
        statusRight.setText(QString::fromStdString(message));
    };
    void SetupRmShortcuts();

    inline QHash<ShortcutTarget, int> GetCurrentTargets() const
    {
        return qmCurrentTargets;
    }
